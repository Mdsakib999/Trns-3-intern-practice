		...
		<div className="p-6 md:max-w-5xl mx-auto">
			...
			<section className="mb-10">
				...
				<p className="mb-2 text-base sm:text-lg">
					<strong>Fontana Logistik und Spedition GmbH</strong>
					<br />
					Darmstädter Landstraße 185, 60598
				</p>
				<p className="mb-2 text-base sm:text-lg">
					<strong>Telefon: </strong>{" "}
					<a href="tel:+494074303440" className="">
						+494074303440
					</a>
					<br />
					<strong>E-Mail: </strong> customs@fontanalogistik.de
				</p>
				<h2 className="text-lg sm:text-xl md:text-2xl font-semibold mt-4 mb-2">
					Vertretungsberechtigter{" "}
				</h2>
				<p className="mb-2 text-base sm:text-lg">
					Geschäftsführer: Jens Berberich
				</p>
				<h2 className="text-lg sm:text-xl md:text-2xl font-semibold mt-4 mb-2">
					Registereintrag
				</h2>
				<p className="mb-2 text-base sm:text-lg">
					...
					<br />
					<strong>Registergericht:</strong> Frankfurt am Main
					<br />
					<strong>Registernummer:</strong> HRB 41284
				</p>
				{/* <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mt-4 mb-2">
        ...
        <p className="mb-2 text-base sm:text-lg">
          Gemäß § 27 a Umsatzsteuergesetz: DE247501028
			...
			<section>
				...
				<p className="mb-4 text-base  sm:text-lg">
					Fontana Logistik und Spedition GmbH
					<br />
					Darmstädter Landstraße 185, 60598
					<br />
					<strong>Telefon:</strong>{" "}
