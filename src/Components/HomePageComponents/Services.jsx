      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-12">
        <div data-aos="fade-right" className="relative">
          ...
          <div className="bg-white px-10 pt-10 pb-16 rounded-2xl">
            ...
            <p className="text-sm text-gray-500">
              Expertise in Zollabwicklungsdiensten für einen reibungslosen
              grenzüberschreitenden Transport. Wir kümmern uns um Dokumentation,
              Compliance, Zollabfertigung sowie die Berechnung von Zöllen und
              Steuern, um kostspielige Verzögerungen zu vermeiden.
            </p>
          </div>
        </div>
        <div data-aos="fade-right" className="relative">
          ...
          <div className="bg-white px-10 pt-10 pb-16 rounded-2xl">
            ...
            <p className="text-sm text-gray-500">
              Sichere und zuverlässige Lagerlösungen in hochmodernen
              Einrichtungen. Bestandsmanagement und Lagermöglichkeiten für
              sowohl kurzfristige als auch langfristige
              Bedürfnisse.Echtzeit-Überwachung des Bestands und effiziente
              Raumausnutzung
            </p>
          </div>
        </div>
        <div data-aos="fade-right" className="relative">
          ...
          <div className="bg-white px-10 pt-10 pb-16 rounded-2xl">
            ...
            <p className="text-sm text-gray-500">
              Kostengünstige Transportlösungen über verschiedene Transportarten:
              Straße, See und Luft.Pünktliche und flexible Transportoptionen, um
              effiziente Lieferzeiten zu gewährleisten.End-to-End-Tracking Ihrer
              Sendungen für vollständige Transparenz.
            </p>
          </div>
        </div>
      </div>
